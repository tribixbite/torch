...
| PKPOWER | 20 | 7.1 |
| YUSTDA | 7 | 7.1 |
| GreatPowerDirect | 6 | 7.2 |


## 7. Spec Verification Flags

135 issues found across 14016 entries.

| Issue | Count |
|-------|-------|
| FL1 mismatch (throw vs intensity) | 74 |
...
- **Fenix TK22 V2 Tactical LED Flashlight - 1600 Lumens - Uses 1 x 21700 or 1 x 18650** (fenix-tk22-v2-tactical-led-flashlight-1600-lumens-uses-1-x-21700-or-1-x-18650): throw=405m → expected 41006cd, got 14133cd (ratio: 0.34)
- **Fenix Flashlights, LD Series** (fenix-flashlights-ld-series): throw=85m → expected 1806cd, got 800cd (ratio: 0.44)
- **Fenix TK45 High Performance** (fenix-tk45-high-performance): throw=200m → expected 10000cd, got 2158cd (ratio: 0.22)
- **FOTTEPP German Mini Flash Super Power** (fottepp-german-mini-flash-super-power): throw=300m → expected 22500cd, got 10000cd (ratio: 0.44)
- **Haikelite AK01 6000lm 750m 21700** (haikelite-ak01-6000lm-750m-21700): throw=750m → expected 140625cd, got 50305cd (ratio: 0.36)
- **Imalent DT70** (imalent-dt70-xhp70): throw=1100m → expected 302500cd, got 96715cd (ratio: 0.32)
- **Imalent R30C** (imalent-r30c-luminus-sst70-led-9000lm-560m-sst-70): throw=560m → expected 78400cd, got 25500cd (ratio: 0.33)
- **JETBeam DDC25 Flashlight - CREE U2 LED - 600 Lumens - Uses 2 x CR123 or 1 x 18650** (jetbeam-ddc25-flashlight-cree-u2-led-600-lumens-uses-2-x-cr123-or-1-x-18650-xm-l2): throw=300m → expected 22500cd, got 5000cd (ratio: 0.22)
- **JETBeam SSA20 Dual Switch Everyday Carry Flashlight - CREE G2 LED - 300 Lumens - Uses 2 x AAs** (jetbeam-ssa20-dual-switch-everyday-carry-flashlight-cree-g2-led-300-lumens-uses-2-x-aas): throw=200m → expected 10000cd, got 3200cd (ratio: 0.32)
- **JETBeam SSA10 Dual Switch Compact Everyday Carry Flashlight - CREE G2 LED - 200 Lumens - Uses 1 x AA** (jetbeam-ssa10-dual-switch-compact-everyday-carry-flashlight-cree-g2-led-200-lumens-uses-1-x-aa): throw=200m → expected 10000cd, got 2100cd (ratio: 0.21)
- **JETBeam Vastlite i7 EDC Rechargeable Keychain** (jetbeam-vastlite-i7-edc-rechargeable-keychain): throw=102m → expected 2601cd, got 600cd (ratio: 0.23)
- **Klarus WL3 USB-C Rechargeable LED Lantern - 1500 Lumens - Uses Built-in 3.7V 13500mAh Li-ion Battery Pack -Power Bank Function - Olive Green or Desert Tan** (klarus-wl3-usb-c-rechargeable-led-lantern-1500-lumens-uses-built-in-3-7v-13500mah-li-ion-battery-pack-power-bank-function-olive-green-or-desert-tan): throw=47m → expected 552cd, got 270cd (ratio: 0.49)
- **Ledlenser P4 Pen** (ledlenser-p4-pen): throw=90m → expected 2025cd, got 17500cd (ratio: 8.64)
- **Ledlenser P3 Keychain** (ledlenser-p3-keychain): throw=60m → expected 900cd, got 3025cd (ratio: 3.36)
- **Lumencraft LED Conversion Kit Compatible/Replacement for Maglite** (lumencraft-led-conversion-kit-compatible-replacement-for-maglite): throw=380m → expected 36100cd, got 6724cd (ratio: 0.19)
- **Lumintop CL2 (Discontinued)** (lumintop-cl2-discontinued): throw=46m → expected 529cd, got 135cd (ratio: 0.26)
- **Lumintop Tool AA2.0 Titanium (Discontinued)** (lumintop-tool-aa2-0-titanium-discontinued): throw=127m → expected 4032cd, got 1291cd (ratio: 0.32)
- **Maglite Mini Pro LED Flashlight - Red - Custom Engraving** (maglite-mini-pro-led-flashlight-red-custom-engraving): throw=96m → expected 2304cd, got 7399cd (ratio: 3.21)
- **Maglite Mini** (maglite-mini): throw=99m → expected 2450cd, got 4970cd (ratio: 2.03)
- **Maglite ® ML50LX™ 2 Cell C** (maglite-ml50lx-2-cell-c): throw=299m → expected 22350cd, got 56cd (ratio: 0.00)
- **Maglite Mini Pro LED Pocket/Purse** (maglite-mini-pro-led-pocket-purse): throw=172m → expected 7396cd, got 2304cd (ratio: 0.31)
- ... and 44 more
...
61 issues found across 14016 entries.
...
12 issues found across 14016 entries.
