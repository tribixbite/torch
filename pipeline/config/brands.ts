...
export const BRANDS: BrandConfig[] = [
	...
	{ name: 'Nightstick', siteUrl: 'https://www.nightstick.com' },
	{ name: 'PowerTac' },
	{ name: 'Malkoff', searchTerms: ['Malkoff flashlight', 'Malkoff Devices'] },
	{ name: 'ReyLight', aliases: ['Reylight'] },
	{ name: 'FourSevens', aliases: ['4Sevens', 'Prometheus Lights'], searchTerms: ['FourSevens flashlight', '4Sevens flashlight'] },
	{ name: 'JETBeam', aliases: ['Jetbeam'] },
	{ name: 'Nextorch' },
	{ name: 'Princeton Tec', searchTerms: ['Princeton Tec flashlight', 'Princeton Tec headlamp'] },
	{ name: 'Nitecore' },
